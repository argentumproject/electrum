...
from electrum_arg.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Argentum address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-arg setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-arg setconfig' to change your settings")
        return True
