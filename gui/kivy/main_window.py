...
#Factory.register('InstallWizard', module='electrum_arg_gui.kivy.uix.dialogs.installwizard')
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_arg.bitcoin import NetworkConstants
    ...
    def on_qr(self, data):
        ...
        from electrum_arg.util import bh2u
        try:
    ...
    def scan_qr(self, on_complete):
        ...
        SimpleScannerActivity = autoclass("org.electrum_arg.qr.SimpleScannerActivity")
