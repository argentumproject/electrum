...
try:
    import electrum_arg
    from electrum_arg.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_arg.bitcoin import serialize_xpub, deserialize_xpub
    ...
    from electrum_arg.util import print_error, to_string, UserCancelled
    from electrum_arg.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
